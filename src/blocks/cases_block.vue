          ...
          <div class="stage flex" id="stage_three">
            ...
            <div class="right">
              <div class="text">
                ...
                стоимость обращения упала с 1250 ₽ до 396 ₽. Итого за 2 месяца
                работы: +262% к количеству обращений и -65% к стоимости
                обращения.<br /><br />Помимо разработки сайта с выстраиванием
                системы по привлечению клиентов, мы приняли участие в масштабном
                ребрендинге стоматологии и помогли «упаковать» клинику абсолютно
                всем - начиная от памятки пациента и бейджа для сотрудников,
        ...
        <div class="case" id="case_2">
          ...
          <div class="casse__content flex-column">
            ...
            <div class="stage flex" id="stage_three">
              ...
              <div class="right">
                <div class="text">
                  Сравнивая статистику ноября 2021 и декабря 2021 видно, что в
                  январе количество обращений выросло до 63 вместо 19 в октябре,
                  а стоимость обращения упала с 1700 ₽ до 396 ₽. Итого за 2
                  месяца работы: +377% к количеству обращений и -70% к стоимости
                  обращения.<br /><br />
                  ...
                  начиная от памятки пациента и бейджа для сотрудников,
                  заканчивая оформлением соцсетей и современными вывесками
