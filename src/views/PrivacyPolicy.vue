    ...
    <div class="wrapper">
      ...
      <div class="privacy-list">
        <div class="privacy-item">
          <div class="privacy-item__title">1. Общие положения</div>
          <div class="privacy-item__content">
            <p>
              ...
              Индивидуальным предпринимателем Кропотиным Константином
        ...
        <div class="privacy-item">
          ...
          <div class="privacy-item__content">
            ...
            <p>
              ...
              законодательством РФ. данные в порядке и случаях, предусмотренных
        ...
        <div class="privacy-item">
          ...
          <div class="privacy-item__content">
            ...
            <ul>
              ...
              <li>
                – составление персонализированных коммерческих предложений по
                услугам для Пользователя.
              </li>
            </ul>
            <p>
              ...
              адрес электронной почты clinic@artgorka.ru с пометкой «Отказ от
        ...
        <div class="privacy-item">
          ...
          <div class="privacy-item__content">
            ...
            <p>
              ...
              https://artclinik.ru или направленные Оператору посредством
            ...
            нение файлов «cookie» и использование технологии JavaScript).
            <p>
        ...
        <div class="privacy-item">
          ...
          <div class="privacy-item__content">
            ...
            <p>
              ...
              Оператора clinic@artgorka.ru с пометкой «Актуализация
              персональных данных».
            </p>
            <p>
              ...
              clinic@artgorka.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
            <p>
        ...
        <div class="privacy-item">
          <div class="privacy-item__title">13. Заключительные положения</div>
          <div class="privacy-item__content">
            <p>
            ...
            <p>
              ...
              сети Интернет по адресу https://artclinik.ru/privacy.
            </p>
          </div>
        </div>
      </div>
  ...
  @media screen and (max-width: 767px) {
    .wrapper {
      .page-title {
        ...
        margin-bottom: calc(40px + 20 * (100vw - 320px) / (767 - 320));
      }
      .privacy-list {
        gap: calc(40px + 20 * (100vw - 320px) / (767 - 320));
        .privacy-item {
          .privacy-item__title {
            font-size: calc(16px + 6 * (100vw - 320px) / (767 - 320));
          }
          .privacy-item__content {
            * {
