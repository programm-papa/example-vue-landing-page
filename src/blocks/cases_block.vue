        ...
        <div class="case" id="case_2">
          ...
          <div class="casse__content flex-column">
            <div class="stage flex" id="stage_one">
              ...
              <div class="right">
                <div class="text">
                  Частной стоматологической клинике необходим дополнительный
                  поток заявок на запись к специалистам.<br /><br />Локация
                  клиники – 1 клиника только в одном городе с населением 230
                  тыс. человек.<br /><br />
                  «ДоДоктор» использует передовые технологии, очень опытный и
                  практикующий руководитель, что качественно отличает их от
                  местных конкурирующих стоматологий.<br /><br />
                  ...
                  фактически ничего не применялось. Использовать для продвижения
                  их текущий сайт было невозможно, учитывая его невнятный стиль
                  рядовой поликлиники, архаичность и явное несоответствие
                  статусу и амбициям клиники.
                </div>
              </div>
            </div>
            <div class="stage flex" id="stage_two">
              ...
              <div class="right">
                <ul class="list flex-column">
                  ...
                  <li>
                    Сформировать стабильный дополнительный поток новых
                    пациентов, увеличить средний чек минимум в 1,5 раза.
                  </li>
                </ul>
              </div>
            </div>
            <div class="stage flex" id="stage_three">
              ...
              <div class="right">
                <div class="text">
                  Сравнивая статистику января 2020 и октября 2019 видно, что в
                  январе количество обращений выросло до 63 вместо 24 в октябре,
                  а стоимость обращения упала с 1250 ₽ до 396 ₽. Итого за 2
                  месяца работы: +262% к количеству обращений и -65% к стоимости
                  обращения.<br /><br />Помимо разработки сайта с выстраиванием
                  системы по привлечению клиентов, мы приняли участие в
                  масштабном ребрендинге стоматологии и помогли «упаковать»
                  клинику абсолютно всем - начиная от памятки пациента и бейджа
                  для сотрудников, заканчивая оформлением соцсетей и
                  современными вывесками снаружи и внутри клиники.
                </div>
              </div>
            </div>
          </div>
